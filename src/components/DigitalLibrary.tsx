  ...
  return (
    <div className="min-h-screen bg-sanctuary-linen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Featured Historical Document - Gilbert's Messiah in His Sanctuary */}
        <div className="mb-8">
          <Link to="/library/gilbert-messiah" className="block">
            <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl shadow-lg border-2 border-teal-600 hover:shadow-2xl hover:border-teal-700 transition-all duration-300 overflow-hidden">
              <div className="flex flex-col md:flex-row">
                {/* Image/Icon Section */}
                <div className="md:w-1/4 bg-gradient-to-br from-teal-900 to-teal-800 flex items-center justify-center p-8">
                  <div className="text-center">
                    <BookOpen className="w-20 h-20 text-teal-200 mx-auto mb-3" />
                    <div className="text-teal-100 text-sm font-semibold">Early 1900s</div>
                  </div>
                </div>
                ...
                <div className="md:w-3/4 p-8">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-lg text-teal-900 font-semibold mb-2">
                        By F.C. Gilbert
                      </p>
                    </div>
                  </div>
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    A comprehensive exploration of sanctuary theology by former rabbi F.C. Gilbert, who converted to Christianity
                    after discovering Jesus as the Messiah through Old Testament prophecy. This systematic 40-chapter study traces
                    the sanctuary from its earthly establishment through Christ's heavenly ministry, the investigative judgment,
                    and the final events before the Second Coming. Written from a unique Jewish-Christian perspective, it presents
                    the sanctuary as the central theme of Scripture and the plan of salvation.
                  </p>

                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div className="flex items-center gap-2 text-sm">
                      <Calendar className="w-4 h-4 text-teal-700" />
                      <span className="text-gray-700"><strong>Published:</strong> Early 1900s</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <BookOpen className="w-4 h-4 text-teal-700" />
                      <span className="text-gray-700"><strong>Chapters:</strong> 40</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Book className="w-4 h-4 text-teal-700" />
                      <span className="text-gray-700"><strong>Scriptures:</strong> 250+</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                      <Star className="w-4 h-4 text-teal-600 fill-current" />
                      <span className="text-gray-700"><strong>Jewish Perspective</strong></span>
                    </div>
                  </div>

                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="text-xs px-3 py-1 bg-teal-100 text-teal-800 rounded-full font-medium">
                      Jewish Background
                    </span>
                    <span className="text-xs px-3 py-1 bg-teal-100 text-teal-800 rounded-full font-medium">
                      Advent Movement
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-teal-200">
                    <div className="flex items-center gap-4">
                      <div className="text-sm text-gray-600">
                        <strong>Interactive Features:</strong> 40 Chapters • Scripture Navigator • Concepts • Timeline • Final Events
                      </div>
                    </div>
